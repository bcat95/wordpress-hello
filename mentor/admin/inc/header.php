...
<html lang="en">
  <head>
    ...
    <link href="<?php echo $base_url; ?>/admin/style/app.css" rel="stylesheet">
    <link href="<?php echo $base_url; ?>/admin/style/trumbowyg.min.css" rel="stylesheet">
...
<header class="navbar navbar-dark navbar-custom sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">Admin CMS</a>
