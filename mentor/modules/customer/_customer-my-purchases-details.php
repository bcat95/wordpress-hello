        ...
        <div class="white-card content-panel">
          ...
          <div>
            <ul class="list-group list-group-flush">
              ...
              <?php endif; ?>             
              <li class="list-group-item"><strong><?php echo $lang['my_purchases_payment_method']; ?>: </strong> <?php if($getPaymentDetails->payment_method == "stripe") echo "<i class='bi bi-stripe fs-5'></i> ".$lang['my_purchases_stripe'].""; else echo "<i class='bi bi-bank fs-5'></i> ".$lang['my_purchases_bank_deposit'].""; ?></li>
              ...
              <?php endif; ?>              
              <li class="list-group-item"><strong><?php echo $lang['my_purchases_status']; ?>:</strong> <?php echo $checkout_status_label; ?></li>
            </ul>  
...
<?php if($checkout_status == "succeeded"){?>
