		          ...
		          <label for="floatingPrompt">Prompt</label>
					...
					<fieldset class="border rounded-2 p-3 mb-4">
					  ...
					  <div class="row">
					    ...
					    <div class="col-md-3">
					      <div class="form-floating mb-3">
					        <input name="max_num_chats_api" type="number" class="form-control" id="floatingMaxNumChatsAPI" placeholder="Max Num Chats API" value="<?php echo (isset($edit) && $edit) ? ($get->max_num_chats_api ?? '') : '10'; ?>" required>
					        <label for="floatingMaxNumChatsAPI">Max Num Chats API</label>
					      </div>
					    </div>
					  	-->
