        ...
        <table class="table table-striped border data-table align-middle">
          ...
          <tbody id="sortableTableBody" data-module="<?php echo $module_name; ?>">
            ...
            <tr data-id="<?php echo $show->id; ?>">
              ...
              <td><div class="wrapper-form-img-icon"><img src="<?php echo $base_url; ?>/public_uploads/<?php echo $show->image; ?>" onerror="this.src='<?php echo $base_url; ?>/admin/img/placeholder.jpg'"></div></td>
